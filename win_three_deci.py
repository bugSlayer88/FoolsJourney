...
class Ui_ThreeDecipher(object):
    ...
    def launch_decipher_window(self):
        ...
        get_pas_meaning = ''
        if pas_card_selected in first_cards:
            get_pas_meaning = main_meaning_major[str(pas_card_selected)]

        if pas_card_selected not in first_cards:
            get_pas_meaning = main_meaning_minor[str(pas_card_selected)]

        self.ui.pas_desc.setText(get_pas_meaning)
        self.ui.pas_desc.setWordWrap(True)

        get_pre_meaning = ''
        if pre_card_selected in first_cards:
            get_pre_meaning = main_meaning_major[str(pre_card_selected)]

        if pre_card_selected not in first_cards:
            get_pre_meaning = main_meaning_minor[str(pre_card_selected)]

        self.ui.pre_desc.setText(get_pre_meaning)
        self.ui.pre_desc.setWordWrap(True)

        get_fut_meaning = ''
        if fut_card_selected in first_cards:
            get_fut_meaning = main_meaning_major[str(fut_card_selected)]

        if fut_card_selected not in first_cards:
            get_fut_meaning = main_meaning_minor[str(fut_card_selected)]
