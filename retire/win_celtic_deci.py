...
class Ui_CelticDecipher(object):
    def setupUi(self, UiCelticDecipher):
        ...
        pixmap = QPixmap('images/marseille/back.png').scaled(88, 158)
        ...
        self.unw_combo.setGeometry(QtCore.QRect(500, 820, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        ...
        self.hom_combo.setGeometry(QtCore.QRect(500, 610, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.hnf_combo.setGeometry(QtCore.QRect(500, 400, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.ans_combo.setGeometry(QtCore.QRect(500, 190, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.ans_img.setPixmap(pixmap)

        self.bef_combo = QtWidgets.QComboBox(parent=UiCelticDecipher)
        self.bef_combo.setGeometry(QtCore.QRect(360, 490, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.blo_img.setPixmap(pixmap)

        self.blo_combo = QtWidgets.QComboBox(parent=UiCelticDecipher)
        self.blo_combo.setGeometry(QtCore.QRect(190, 800, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.bhi_combo.setGeometry(QtCore.QRect(20, 490, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.abv_combo.setGeometry(QtCore.QRect(180, 200, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.obs_combo.setGeometry(QtCore.QRect(190, 570, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
        ...
        self.you_combo.setGeometry(QtCore.QRect(190, 410, 150, 22))
        font = QtGui.QFont()
        font.setFamily("Adobe Hebrew")
        font.setPointSize(12)
    ...
    def launch_decipher_window(self):
        ...
        self.ui.you_card_title.setText(you_card_selected)
        self.ui.you_card_title.setWordWrap(True)

        self.ui.obs_card_title.setText(obs_card_selected)
        self.ui.obs_card_title.setWordWrap(True)

        self.ui.abv_card_title.setText(abv_card_selected)
        self.ui.abv_card_title.setWordWrap(True)

        self.ui.blo_card_title.setText(blo_card_selected)
        self.ui.blo_card_title.setWordWrap(True)

        self.ui.bhi_card_title.setText(bhi_card_selected)
        self.ui.bhi_card_title.setWordWrap(True)

        self.ui.bef_card_title.setText(bef_card_selected)
        self.ui.bef_card_title.setWordWrap(True)

        self.ui.unw_card_title.setText(unw_card_selected)
        self.ui.unw_card_title.setWordWrap(True)

        self.ui.hom_card_title.setText(hom_card_selected)
        self.ui.hom_card_title.setWordWrap(True)

        self.ui.hnf_card_title.setText(hnf_card_selected)
        self.ui.hnf_card_title.setWordWrap(True)

        self.ui.ans_card_title.setText(ans_card_selected)
